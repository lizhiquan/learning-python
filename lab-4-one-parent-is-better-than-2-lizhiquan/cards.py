...
class IDCard(Expirable, Card):
    ...
    This class implements and inherits the Expirable interface and the
    Card base class.
    """
...
class GiftCard(Expirable, BalanceCard):
    ...
    This class inherits the BalanceCard class and implements the
    Expirable interface.
    """
    ...
    def validate_card(self) -> bool:
        ...
        :return: True if valid, False otherwise
        """
        return super().validate_card() and not self.expired and \
